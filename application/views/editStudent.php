...
<div id="container">
	...
	<?php endif; ?>
	<div class="jumbotron">
	<h6 class="text-center text-bold display-3">Edit Student</h6>
	<hr>
</div>
<div class="row">
<div class="col-md-6">
<div class="form-group">
	...
	<div class="col-md-9">
		<?php echo form_input(['name' => 'studentname','class'=>'form-control','placeholder'=>'Nick124','value'=>set_value('studentname',$studentData->studentname)]); ?>
	</div>
</div>
</div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-9">
		<?php echo form_input(['name' => 'email','class'=>'form-control','placeholder'=>'as273863@gmail.com','value'=>set_value('user_name',$studentData->email)]); ?>
	</div>
</div>
</div>
</div>
...
<div class="form-group">
	...
	<div class="col-md-9">
		<?php echo form_input(['name' => 'course','class'=>'form-control','placeholder'=>'Computer Science','value'=>set_value('course',$studentData->course)]); ?>
	</div>
</div>
</div>
</div>
...
<button type="submit" class="btn btn-primary ml-3 mt-3">SAVE</button>
<?php echo anchor("admin/viewStudents/{$studentData->id}","BACK",['class'=>'ml-3 mt-3 btn btn-secondary']); ?>
<div>
<?php echo form_close(); ?>
</div>
